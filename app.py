...
st.set_page_config(page_title="Isuzu 4JJ1 AI System",import streamlit as st
import pandas as pd
import hashlib
import os
from sklearn.ensemble import RandomForestClassifier
    ...
    with tab3:
        ...
        if st.button("📥 Generate PDF Report"):
            if not keywords_list or not ai_suggestions:
                ...
                pdf_path = "/mnt/data/maintenance_report.pdf"
                pdf.output(pdf_path)
                with open(pdf_path, "rb") as f:
                    st.download_button("📄 Download PDF", f, file_name="maintenance_report.pdf") layout="centered")
