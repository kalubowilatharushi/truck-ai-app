...
if not st.session_state.logged_in:
    st.title("🔐 Login to Truck AI System")
...
# ---------- Dashboard ----------
if page == "Dashboard":
    st.title("🚛 Truck AI - Health Dashboard")
...
# ---------- Note Analyzer ----------
    ...
    if st.button("Analyze"):
        if not text.strip():
            st.warning("⚠ Please enter mechanic notes.")
        else:
            ...
            if not matched_terms:
                st.error("❌ No relevant technical keywords found.")
            else:
